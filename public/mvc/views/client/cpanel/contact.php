					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +84348390794</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> khanhnvbgcs200892@greenwich.vn</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="social-icons pull-right">
							<ul class="nav navbar-nav">
								<li><a href="https://www.facebook.com/bonklanchunkmuoi1704"><i class="fab fa-facebook"></i></a></li>
								<li><a href="https://www.youtube.com/channel/UC2DJftrzR936rjzTjea9Jzw"><i class="fab fa-youtube"></i></a></li>
    		...
    		<div class="row" style="margin-top: 100px;">  	
	    		...
	    		<div class="col-sm-4">
	    			<div class="contact-info">
	    				...
	    				<address>
	    					<p>Nguyen Vu Bao Khanh</p>
							<p>90 Nguyên Hồng, phuuwòng 11, quận Bình Thạnh, TP. Hồ Chí Minh</p>
							<p>Số Điện thoại: +84348390794</p>
							<p>Email: khanhnvbgcs200892@greenwich.vn</p>
	    				</address>
	    			</div>
    			</div>    			
	    	</div>  
